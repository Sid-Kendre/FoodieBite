...
import com.example.foodorderingapp.adapter.DashboardFragmentAdapter
import com.example.foodorderingapp.model.Restaurant
import com.example.foodorderingapp.utils.ConnectionManager
...
class DashboardFragment(val contextParam: Context) : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.sort -> {
                val radioButtonView = View.inflate(
                    contextParam,
                    R.layout.sort_radio_button,
                    null
                )

                val radioHighToLow = radioButtonView.findViewById<RadioButton>(R.id.radio_high_to_low)
                val radioLowToHigh = radioButtonView.findViewById<RadioButton>(R.id.radio_low_to_high)
                val radioRating = radioButtonView.findViewById<RadioButton>(R.id.radio_rating)
